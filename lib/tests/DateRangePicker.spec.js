        ...
        describe('if state.selectedStartDate is undefined', function () {
          ...
          describe('if the date is not disabled and is selectable', function () {
            ...
            it('if props.singleDateRange is true, it calls #highlightRange', function () {
              ...
              expect((0, _areMomentRangesEqual2.default)(range, moment.range(this.date, this.date))).toBe(true);
            });
          });
        });
      });
  ...
  describe('#sanitizeRange', function () {
    ...
    describe('if forwards is true', function () {
      ...
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        ...
        expect((0, _areMomentRangesEqual2.default)(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2002, 1, 15))))).toBe(true);
      });
      ...
      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        ...
        expect((0, _areMomentRangesEqual2.default)(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      ...
      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        ...
        expect((0, _areMomentRangesEqual2.default)(range, moment.range(moment(new Date(2006, 1, 15)), moment(new Date(2001, 1, 20))))).toBe(true);
      });
      ...
      it('otherwise it returns the full range', function () {
        ...
        expect((0, _areMomentRangesEqual2.default)(range, moment.range(moment(new Date(2001, 1, 15)), moment(new Date(2001, 1, 17))))).toBe(true);
      });
    });
    ...
    describe('otherwise', function () {
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        ...
        expect((0, _areMomentRangesEqual2.default)(range, moment.range(moment(new Date(2003, 1, 15)), moment(new Date(2005, 1, 15))))).toBe(true);
      });
