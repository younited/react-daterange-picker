...
var _datesInMonthFrom = require('../utils/datesInMonthFrom');

var _datesInMonthFrom2 = _interopRequireDefault(_datesInMonthFrom);
...
var CalendarMonth = function (_BemMixin) {
  ...
  (0, _createClass3.default)(CalendarMonth, [{
    ...
    value: function render() {
      ...
      var monthDates = _immutable2.default.fromJS((0, _datesInMonthFrom2.default)(firstOfWeek, firstOfMonth.year(), firstOfMonth.month()));
